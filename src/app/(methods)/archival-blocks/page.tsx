    ...
    <>
      ...
      <section className="space-y-6 mb-8">
        ...
        <PageSection title="2. Get block with full transaction details">
          <p className="text-sm text-muted-foreground mb-4">
            Set <code className="bg-muted px-1 rounded">transactionDetails: &quot;full&quot;</code>{' '}
            to get complete transaction data with parsed instructions.
          </p>
      ...
      <section className="p-4 bg-muted/50 rounded-lg mb-8">
        ...
        <ul className="list-disc list-outside ml-5 text-sm text-muted-foreground space-y-1">
          <li>
            <strong>Archival access required:</strong> Historical blocks older than a few days need
            archival RPC nodes. Helius includes archival access on all plans.
          </li>
          <li>
      ...
      <WarningBanner title="About the Genesis Block" className="mb-8">
        <ul className="list-disc list-outside ml-5 mt-1 space-y-1">
          ...
          <li>The genesis block contains initial validator configurations and system accounts.</li>
          <li>Unlike Bitcoin, Solana does not have a coinbase message in its genesis block.</li>
          <li>Early Solana blocks are historically significant for researchers and archivists.</li>
        </ul>
      </WarningBanner>
