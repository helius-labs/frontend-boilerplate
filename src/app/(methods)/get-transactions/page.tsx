    ...
    <>
      ...
      <InfoBox title="API Notes">
        <ul className="list-disc list-outside ml-5 space-y-2">
          ...
          <li>
            <strong>Transaction types:</strong> Enhanced API classifies transactions into types like
            TRANSFER, SWAP, NFT_SALE, NFT_MINT, STAKE_SOL and more.
          </li>
          <li>
            <strong>Rate limits:</strong> Both endpoints share the same rate limits. Use appropriate
            caching and pagination to avoid hitting limits.
          </li>
        </ul>
      </InfoBox>
