    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
        <div className="flex items-center gap-3">
          <div className="size-10 rounded-full bg-black flex items-center justify-center p-2">
            <svg viewBox="0 0 101 88" fill="none" className="size-full">
              <path
